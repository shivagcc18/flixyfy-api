    ...
    out.update(
        {
            ...
            "availability_status": correction["availability_status"],
            "provider_display_primary_key": correction["provider_key"],
            "provider_display_primary_name": correction["provider_display_name"],
            "provider_display_primary_label": f"Search on {correction['provider_display_name']}",
            "provider_public_label": f"Search on {correction['provider_display_name']}",
            ...
            "provider_display_reason": "provider_correction_overlay_card",
            "provider_public_count": 1,
            "provider_hidden_count": 0,
            "provider_policy_version": PROVIDER_DISPLAY_POLICY_VERSION,
            "final_url": correction.get("search_url") or correction.get("homepage_url"),
            "search_url": correction.get("search_url"),
            "homepage_url": correction.get("homepage_url"),
