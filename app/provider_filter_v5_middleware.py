...
CONFIGS = {
    ...
    "/api/v3/historical": {"domain": "historical", "label": "Historical Movies", "prefix": "/historical/", "content": ["historical_movie_serving_v5", "historical_movie_serving_v5_backend_compat", "historical_card_serving_v1", "historical_serving_v2", "historical_serving_v1"], "availability": ["historical_availability_serving_v5", "historical_availability_serving_v3", "historical_availability_serving_v2", "historical_availability_v2", "provider_availability_serving_v1"]},
    "/api/v3/webseries": {"domain": "webseries", "label": "Webseries", "prefix": "/webseries/", "content": ["webseries_series_serving_v5", "webseries_serving_v5", "webseries_card_serving_v1", "webseries_serving_v1"], "availability": ["webseries_availability_serving_v5", "webseries_availability_serving_v3", "webseries_availability_serving_v2", "webseries_availability_serving_v1", "webseries_availability_v1", "provider_availability_serving_v1"]},
    "/api/v3/web-series": {"domain": "webseries", "label": "Webseries", "prefix": "/webseries/", "content": ["webseries_series_serving_v5", "webseries_serving_v5", "webseries_card_serving_v1", "webseries_serving_v1"], "availability": ["webseries_availability_serving_v5", "webseries_availability_serving_v3", "webseries_availability_serving_v2", "webseries_availability_serving_v1", "webseries_availability_v1", "provider_availability_serving_v1"]},
    "/api/v3/series": {"domain": "webseries", "label": "Webseries", "prefix": "/webseries/", "content": ["webseries_series_serving_v5", "webseries_serving_v5", "webseries_card_serving_v1", "webseries_serving_v1"], "availability": ["webseries_availability_serving_v5", "webseries_availability_serving_v3", "webseries_availability_serving_v2", "webseries_availability_serving_v1", "webseries_availability_v1", "provider_availability_serving_v1"]},
}
